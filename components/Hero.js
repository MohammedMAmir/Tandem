...
export default function Hero() {
  return (
    <div className='py-4 md:py-10 flex flex-col gap-6 sm:gap-10'>
      <h1 className={'text-5xl sm:text-6xl md:textxl text-center ' + sansitaLight.className}>
        <span className={'textGradientPrime ' + sansita.className}>Tandem</span> keeping partners in step, 
        <span className={'textGradientPrime ' + sansita.className}> no matter the distance</span></h1>
